...
@ApiModel(description = "Estructura con la informacion de los productos registrados")
public class Response implements java.io.Serializable {

    @ApiModelProperty(notes = "Campo que indica el estado de la consulta")
    private Status status;

    @ApiModelProperty(notes = "Listado de productos registrados en el sistema de toures balon")
